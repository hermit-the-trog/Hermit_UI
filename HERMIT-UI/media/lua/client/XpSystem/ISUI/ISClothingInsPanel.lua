...
--** Hermit's color scheme

--# Red (9c191c)
--# ARGB: (1, 0.61, 0.10, 0.11)
--# RGBA: (0.61, 0.10, 0.11, 1)
--# RGB255: (156, 25, 28)

--# Blue (5dc6cc) val = 0.00
--# ARGB: (1, 0.36, 0.78, 0.80)
--# RGBA: (0.36, 0.78, 0.80, 1)
--# RGB255: (93, 198, 204)

--# Yellow (e9b623)
--# ARGB: (1, 0.91, 0.71, 0.14)
--# RGBA: (0.91, 0.71, 0.14, 1)
--# RGB255: (233, 182, 35)

--# Gold (d89028)
--# ARGB: (1, 0.85, 0.56, 0.16)
--# RGBA: (0.85, 0.56, 0.16, 1)
--# RGB255: (216, 144, 40)

--# Brown (8c451f)
--# ARGB: (1, 0.55, 0.27, 0.12)
--# RGBA: (0.55, 0.27, 0.12, 1)
--# RGB255: (140, 69, 31)

--# Green (8dc63f)
--# ARGB: (1, 0.55, 0.78, 0.25)
--# RGBA: (0.55, 0.78, 0.25, 1)
--# RGB255: (141, 198, 63)
...
function ISClothingInsPanel:create()
    ...
    local colorScheme = {
        { val = 0.00, color = Color.new(  28/255,  117/255, 188/255, 1 ) },
        { val = 0.25, color = Color.new(  0/255, 167/255, 157/255, 1 ) },
        { val = 0.50, color = Color.new(  0/255, 148/255, 68/255, 1 ) },
        { val = 0.75, color = Color.new(  216/255, 144/255, 40/255, 1 ) },
        { val = 1.00, color = Color.new(  156/255, 25/255, 28/255, 1 ) },
    };
    self.colorScheme = colorScheme;

    local colorSchemeBlues = {
        { val = 0.00, color = Color.new(  0/255, 148/255,  71/255, 1 ) },
        { val = 0.50, color = Color.new(   0/255, 167/255, 158/255, 1 ) },
        { val = 1.00, color = Color.new(  27/255,  118/255, 188/255, 1 ) },
    }
...
function ISClothingInsPanel:render()
    ...
    if not self.selectedBodyPart then
        self:drawRectBorder(130, 10, 265, self.coreRectangleH, 0.0, 0, 0, 0);
    else
        self:drawRectBorder(130, 10, 265, self.coreRectangleH, 0.0, 0, 0, 0);

        self:drawRect(self.bpAnchorX, self.bpPanelY+self.bpAnchorY-1, 130-self.bpAnchorX, 3, 0.0, 0.0, 0.0, 0.0);
        self:drawRect(self.bpAnchorX, self.bpPanelY+self.bpAnchorY, 130-self.bpAnchorX, 1, 0.0, 0.0, 0.0, 0.0);
    end
...
function ISClothingInsPanel:new(player, x, y, width, height)
    ...
    o.titleColor = {r=0.85, g=0.56, b=0.03, a=1.0};
    o.defTextColor = {r=0.55, g=0.26, b=0.01, a=1.0};
