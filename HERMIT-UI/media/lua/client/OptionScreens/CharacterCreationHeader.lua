...
function AvatarPanel:createChildren()
	...
	self.avatarPanel.backgroundColor = {r=0, g=0, b=0, a=1}
	self.avatarPanel.borderColor = {r=0, g=0, b=0, a=1}
...
function AvatarPanel:prerender()
	...
	self:drawRectBorder(self.avatarPanel.x - 2, self.avatarPanel.y - 2, self.avatarPanel.width + 4, self.avatarPanel.height + 4, 0.0, 0, 0, 0);
...
function CharacterCreationHeader:create()
	...
	local comboHgt = FONT_HGT_SMALL + 3 * 2
	self.avatarPanel = AvatarPanel:new(64, 64, 240, 480 + comboHgt) -- 128*1.5=192, 256*1.5=384
	self:addChild(self.avatarPanel)
...
--	self.surnameEntry:setAnchorRight(true);
	...
	self.genderCombo.borderColor = {r=0.0, g=0.0, b=0.0, a=0.95};
...
function CharacterCreationHeader:render()
	...
	self:drawTextRight(getText("UI_characreation_forename"), textX, self.forenameEntry:getY(), 1, 1, 1, 1, UIFont.Small);
	self:drawTextRight(getText("UI_characreation_surname"), textX, self.surnameEntry:getY(), 1, 1, 1, 1, UIFont.Small);
