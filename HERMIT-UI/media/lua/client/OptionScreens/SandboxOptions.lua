...
function SandboxOptionsScreenListBox:doDrawItem(y, item, alt)
    self:drawRectBorder(0, y, self:getWidth(), self.itemheight - 1, 0.95, 0, 0, 0)

    if item.item.category then
        self:drawRect(0, y, self:getWidth(), self.itemheight - 1, 1, 0.55, 0.26, 0.01)
...
function SandboxOptionsScreenPanel:render()
    self:drawRectBorderStatic(0, 0, self.width, self.height, 0.95, 0, 0, 0)
...
function SandboxOptionsScreen:render()
    ...
    if self.listbox.joyfocus then
        ...
        self:drawRectBorder(ui:getX(), ui:getY(), ui:getWidth(), ui:getHeight(), 0.95, 0.85, 0.56, 0.03)
        -- self:drawRectBorder(ui:getX()+1, ui:getY()+1, ui:getWidth()-2, ui:getHeight()-2, 0.95, 0.85, 0.56, 0.03)
    ...
    elseif self.presetPanel.joyfocus then
        ...
        self:drawRectBorder(ui:getX() - 4, ui:getY() - 4, ui:getWidth() + 4 + 3, ui:getHeight() + 4 + 3, 0.95, 0.85, 0.56, 0.03)
        -- self:drawRectBorder(ui:getX() - 3, ui:getY() - 3, ui:getWidth() + 3 + 2, ui:getHeight() + 4 + 2, 0.95, 0.85, 0.56, 0.03)
    end
end
