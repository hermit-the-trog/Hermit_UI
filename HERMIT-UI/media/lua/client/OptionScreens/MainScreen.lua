...
function MainScreen:instantiate()
    ...
    self.bottomPanel.backgroundColor = {r=0, g=0, b=0, a=0.95};
    ...
    if not self.inGame and not isDemo() then
        ...
        self.joinServer.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.joinServer.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.bootstrapConnectPopup.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.bootstrapConnectPopup.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.connectToServer.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.connectToServer.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.serverConnectPopup.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.serverConnectPopup.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.joinPublicServer.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.joinPublicServer.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.soloScreen.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.soloScreen.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.loadScreen.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.loadScreen.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.onlineCoopScreen.backgroundColor = { r = 0, g = 0, b = 0, a = 0.95 };
        self.onlineCoopScreen.borderColor = { r =0, g = 0, b = 0, a = 0.95 };
        ...
        if WorkshopSubmitScreen.TEST or getSteamModeActive() then
            ...
            self.workshopSubmit.backgroundColor = {r=0, g=0, b=0, a=0.95}
            self.workshopSubmit.borderColor = {r=0, g=0, b=0, a=0.95}
        end
        ...
        if getSteamModeActive() then
            ...
            self.serverWorkshopItem.backgroundColor = {r=0, g=0, b=0, a=0.95}
            self.serverWorkshopItem.borderColor = {r=0, g=0, b=0, a=0.95}
        end
    end
    ...
    self.mainOptions.backgroundColor = {r=0, g=0, b=0, a=0.95};
    self.mainOptions.borderColor = {r=0, g=0, b=0, a=0.95};
    ...
    elseif not isDemo() then
        ...
        self.sandOptions.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.sandOptions.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.worldSelect.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.worldSelect.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.mapSpawnSelect.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.mapSpawnSelect.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.modSelect.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.modSelect.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.charCreationMain.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.charCreationMain.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.charCreationProfession.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.charCreationProfession.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.charCreationHeader.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.charCreationHeader.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.lastStandPlayerSelect.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.lastStandPlayerSelect.borderColor = {r=0, g=0, b=0, a=0.95};
        ...
        self.serverSettingsScreen.backgroundColor = {r=0, g=0, b=0, a=0.95};
        self.serverSettingsScreen.borderColor = {r=0, g=0, b=0, a=0.95};
    end
...
--    self.bottomPanel:setX(logoX)
    ...
    self.versionDetail.borderColor = {r=0.1, g=0.1, b=0.1, a=0.95};
    ...
    if self.inGame then
        ...
        self.modListDetail.borderColor = {r=0.1, g=0.1, b=0.1, a=0.95};
    ...
    if not self.inGame then
        ...
        self.termsOfService.borderColor = {r=0.1, g=0.1, b=0.1, a=0.95};
...
--            padLeft = 2 + 20 + 2
        ...
        self:drawRect(0 - padLeft, 0, self:getWidth() + padLeft + padRight, self:getHeight(), alpha, 0.55, 0.26, 0.01)
    end
...
function MainScreen:onClickVersionDetail()
    if not self.infoRichText then
        ...
        self.infoRichText.backgroundColor = {r=0, g=0, b=0, a=0.95};
