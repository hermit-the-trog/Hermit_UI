...
function CharacterCreationProfession:create()
	...
	self.mainPanel.backgroundColor = { r = 0, g = 0, b = 0, a = 0.95 };
	self.mainPanel.borderColor = { r = 0, g = 0, b = 0, a = 0.95 };
...
--	self:addChild(MainScreen.instance.charCreationHeader);
    ...
    --	self.addTraitBtn.borderColor = { r = 0.1, g = 0.1, b = 0.1, a = 0.95 };
    ...
    --	self.removeTraitBtn.borderColor = { r = 0.1, g = 0.1, b = 0.1, a = 0.95 };
    ...
    self.randomButton.borderColor = { r = 0.1, g = 0.1, b = 0.1, a = 0.95 };
	...
	self.resetButton.borderColor = { r = 0.1, g = 0.1, b = 0.1, a = 0.95 };
    ...
    self.infoBtn.borderColor = { r = 0.1, g = 0.1, b = 0.1, a = 0.95 };
    ...
    self.saveBuildButton.borderColor = { r = 0.1, g = 0.1, b = 0.1, a = 0.95 };
    ...
    self.deleteBuildButton.borderColor = { r = 0.1, g = 0.1, b = 0.1, a = 0.95 };
...
function CharacterCreationProfession:update()
	...
	if self.deleteBuildButton:isEnabled() then
		self.deleteBuildButton.borderColor.a = 0.0
	end
end
