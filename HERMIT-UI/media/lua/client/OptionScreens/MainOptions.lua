...
function HorizontalLine:render()
	self:drawRect(0, 0, self.width, 1, 1, 0.55, 0.26, 0.01)
end
...
function MainOptions:addHorizontalLine(y, text)
	...
	local label = ISLabel:new(100, self.addY + y + 8, FONT_HGT_MEDIUM, text, 0.85, 0.56, 0.03, 1, UIFont.Medium)
	label:setX(50)
	label:initialise()
...
--	self.tabs.tabHeight = self.tabs.tabHeight + 12
	...
	self.acceptButton.borderColor = {r=0, g=0, b=0, a=0};
	...
	self.saveButton.borderColor = {r=0, g=0, b=0, a=0};
