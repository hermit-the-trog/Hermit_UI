...
function ISDebugUtils.addButton(_self, _data, _x, _y, _w, _h, _title, _func)
    ...
    button:initialise();
    button.backgroundColor = {r=0, g=0, b=0, a=0.95};
    button.backgroundColorMouseOver = {r=0.55, g=0.26, b=0.01, a=1};
    button.borderColor = {r=0.0, g=0.0, b=0.0, a=0.0};
...
function ISDebugUtils.renderHorzBars(_self)
    ...
    for k,v in ipairs(_self.horzBars) do
        _self:drawRect(_self.horzBarX, v, _self.horzBarW, 1, 1.0, 0.05, 0.05, 0.05);
    end
end
