...
function ISItemDropBox:new (x, y, width, height, storeItem, target, onItemDropped, onItemRemove, onVerifyItem, onDragSelf)
    ...
    o.doHighlight = true;
    o.backgroundColorHL = {r=0.55, g=0.26, b=0.01, a=1.0}; --Highlights
    o.borderColorHL = {r=0.55, g=0.26, b=0.01, a=1.0};
    o.doValidHighlight = true;
    o.backgroundColorHLVal = {r=0.92, g=0.71, b=0.15, a=1.0};  --Highlights
    o.borderColorHLVal = {r=0.92, g=0.71, b=0.15, a=1.0}; 
    o.doInvalidHighlight = true;
    o.backgroundColorHLInv = {r=0.55, g=0.02, b=0.02, a=1.0}; --Invalid placement Highlights
    o.borderColorHLInv = {r=0.55, g=0.02, b=0.02, a=1.0};
    o.width = width;
    o.height = height;
    o.anchorLeft = true;
    o.anchorRight = false;
