...
function ISSliderPanel:new (x, y, width, height, target, onValueChange, customPaginate)
    ...
    o.buttonColor = {r=0.55, g=0.26, b=0.01, a=1.0};
    o.buttonMouseOverColor = {r=0.85, g=0.56, b=0.03, a=1.0};           

    o.sliderColor = {r=0.55, g=0.16, b=0.01, a=1.0};
    o.sliderMouseOverColor = {r=0.85, g=0.56, b=0.03, a=1.0};           
    o.sliderBorderColor = {r=1.0, g=1.0, b=1.0, a=1};

    o.sliderBarColor = {r=0.1, g=0.1, b=0.1, a=1.0};
    o.sliderBarBorderColor = {r=0.0, g=0.0, b=0.0, a=1};
