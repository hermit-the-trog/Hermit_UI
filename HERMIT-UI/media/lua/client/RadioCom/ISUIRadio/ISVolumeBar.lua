...
function ISVolumeBar:new (x, y, width, height, onVolumeChange, onVolumeChangeTarget)
    ...
    o.posChange = false;
    o.innerMargin = 4;
    o.greyCol = { r=0.1,g=0.1,b=0.1,a=1};
    o.elBackgroundColor = {r=0, g=0, b=0, a=1.0};
    o.elHighlightColor = {r=0.16, g=0.85, b=0.85, a=1.0};
    o.elHoverColor = {r=0.92, g=0.71, b=0.15, a=1.0};           
    o.elBorderColor = {r=0, g=0, b=0, a=0};
    o.elBorderHighlightColor = {r=1, g=1, b=1, a=1.0};
