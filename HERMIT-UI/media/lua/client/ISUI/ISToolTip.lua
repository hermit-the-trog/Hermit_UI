...
function ISToolTip:render()
	...
	self:drawRect(0, 0, self.width, self.height, 0.0, 0.0, 0.0, 0.95)
	self:drawRectBorder(0, 0, self.width, self.height, 0.0, 0.0, 0.0, 0.95)
	...
	-- render name
	if self.name then
		self:drawText(self.name, 8, 5, 0.85, 0.56, 0.03, 1, UIFont.Medium)
	end
...
function ISToolTip:reset()
    ...
    self.texture = nil
    self.footNote = nil
    setRGBA(self.borderColor, 0.0, 0.0, 0.0, 0.95)
    setRGBA(self.backgroundColor, 0.0, 0.0, 0.0, 0.95)
    self.width = 0
    self.height = 0
    ...
    setRGBA(self.descriptionPanel.backgroundColor, 0, 0, 0, 0.95)
    setRGBA(self.descriptionPanel.borderColor, 0, 0, 0, 0.95)
    self.owner = nil
...
function ISToolTip:new()
   ...
   o.descriptionPanel.backgroundColor = {r=0, g=0, b=0, a=0.95};
   o.descriptionPanel.borderColor = {r=0, g=0, b=0, a=0.95};
   o.owner = nil
   o.followMouse = true
   return o;
end
