...
function ISScavengeUI:new(x, y, width, height, player, zone, clickedSquare)
    ...
    o.buttonBorderColor = {r=0.0, g=0.0, b=0.0, a=0.8}; --black -- color buttons look weird without border here.
	o.buttonBackgroundColor = {r=0.55, g=0.26, b=0.01, a=1.0}; --brown
    o.itemsScavenged = {};
    o.maxItem = 4
    --    o.itemScavenged = nil;
