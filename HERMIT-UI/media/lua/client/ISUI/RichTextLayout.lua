...
function ISRichTextLayout:render(x, y, ui)
	...
	if ISRichTextLayout.drawMargins then
		ui:drawRectBorder(x, y, self.width, self.height, 0.95,0,0,0)
		ui:drawRect(x + self.marginLeft, y, 1, self.height, 0.95,0,0,0)
		local maxLineWidth = self.maxLineWidth or (self.width - self.marginRight - self.marginLeft)
		ui:drawRect(x + self.marginLeft + maxLineWidth, y, 1, self.height, 0.95,0,0,0)
		ui:drawRect(x, y + self.marginTop, self.width, 1, 0.95,0,0,0)
		ui:drawRect(x, y + self.height - self.marginBottom, self.width, 1, 0.95,0,0,0)
	end
