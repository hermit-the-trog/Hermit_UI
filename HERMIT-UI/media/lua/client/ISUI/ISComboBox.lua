...
function ISComboBoxPopup:render()
    ...
    self:drawRectBorderStatic(-1, -1, self:getWidth() + 2, self:getHeight() + 2, 0.08, 0.08, 0.08, 1) --hermit
...
function ISComboBox:prerender()
	...
	elseif self.options[self.selected] then
		...
		if not self.disabled then
			...
			self:drawText(self:getOptionText(self.selected), 10, y, 0.55, 0.26, 0.01, 1, self.font);
		end
...
function ISComboBox:new (x, y, width, height, target, onChange, onChangeArg1, onChangeArg2)
	...
	o.x = x;
	o.y = y;
	o.backgroundColor = {r=0.08, g=0.08, b=0.08, a=1.0};
	o.backgroundColorMouseOver = {r=0.85, g=0.56, b=0.03, a=1.0}; 
	o.borderColor = {r=0.08, g=0.08, b=0.08, a=1.0}; 
	o.font = UIFont.Small
