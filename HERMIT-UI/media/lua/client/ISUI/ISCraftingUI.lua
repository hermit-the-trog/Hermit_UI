...
--    y = y + 10;
    ...
    if self.drawJoypadFocus and self.recipeListHasFocus then
        ...
        self:drawRectBorder(ui:getX(), dy + ui:getY(), ui:getWidth(), ui:getHeight(), 1, 0.55, 0.26, 0.01);
        self:drawRectBorder(ui:getX()+1, dy + ui:getY()+1, ui:getWidth()-2, ui:getHeight()-2, 1, 0.55, 0.26, 0.01);
    elseif self.drawJoypadFocus and self.ingredientPanel:getIsVisible() then
        local ui = self.ingredientPanel
        self:drawRectBorder(ui:getX(), ui:getY(), ui:getWidth(), ui:getHeight(), 1, 0.55, 0.26, 0.01);
        self:drawRectBorder(ui:getX()+1, ui:getY()+1, ui:getWidth()-2, ui:getHeight()-2, 1, 0.55, 0.26, 0.01);
