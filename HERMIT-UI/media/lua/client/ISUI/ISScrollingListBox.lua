...
function ISScrollingListBox:render()
	if self.joyfocus then
		self:drawRectBorder(0, -self:getYScroll(), self:getWidth(), self:getHeight(), 1, 0.85, 0.55, 0.03);
	end
end
...
function ISScrollingListBox:new (x, y, width, height)
	...
	o.y = y;
	o:noBackground();
    o.backgroundColor = {r=0.0, g=0.0, b=0.0, a=0.95}; --hermit
    o.borderColor = {r=0.0, g=0.0, b=0.0, a=0.95};  --hermit
	o.altBgColor = {r=0.1, g=0.1, b=0.1, a=0.1 }
	o.listHeaderColor = {r=0.55, g=0.26, b=0.01, a=1.0}; --brown
