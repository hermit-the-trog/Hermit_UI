...
function ISMoveableInfoWindow:render()
    ...
    if self.header and self.bodyText and self.footer then
        -- background
        self:drawRect(0, 0, self.width, self.height, 0.95, 0.0, 0.0, 0.0);
        self:drawRectBorder(0, 0, self.width, self.height, 0.95, 0.0, 0.0, 0.0);
...
function ISMoveableInfoWindow:new(x, y, character, drag)
    ...
    o.backgroundColor = {r=0.0, g=0.0, b=0.0, a=1};
    o.width = 0;
    o.height = 0;
    o.anchorLeft = true;
    o.anchorRight = false;
    ...
    o.header = TextDrawObject.new(234, 182, 37, true, true, true, true, true, true); --TextDrawObject.new(227, 207, 87, true, true, true, true, true, true);
    ...
    o.footer = TextDrawObject.new(217, 143, 7, true, true, true, true, true, true);
